# [WARNING]: This template is working but not updated anymore, check the [VueJS Template](https://github.com/HugoRCD/vuejs-boilerplate) one for more features and update !!!
